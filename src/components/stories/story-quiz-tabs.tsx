...
export const StoryQuizTabs: React.FC<TabsProps> = ({
  ...
  return (
    <div
      className={`${styles.root} from-purple-50 via-purple-200 to-purple-300 flex-1 flex flex-col h-full rounded-none sm:rounded-xl shadow-lg p-1 sm:p-2 md:p-6 overflow-hidden border-2`}
    >
      <Tabs
        defaultValue="story"
      ...
      >
        ...
        >
          <TabsList
            className={`${styles.list} inline-flex bg-white/80 border border-purple-200 p-1 h-auto`}
          >
            <TabsTrigger
              value="story"
